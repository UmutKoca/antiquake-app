...
if platform.system() == 'Windows':
    # Windows için GDAL kütüphane yolu
    GDAL_LIBRARY_PATH = os.environ.get('GDAL_LIBRARY_PATH', r'C:\OSGeo4W\bin\gdal309.dll')
elif platform.system() == 'Darwin':
    # macOS için GDAL kütüphane yolu
    GDAL_LIBRARY_PATH = os.environ.get('GDAL_LIBRARY_PATH', '/opt/homebrew/Cellar/gdal/3.9.3_1/lib/libgdal.dylib')
else:
    # Diğer sistemler (örneğin Linux)
    GDAL_LIBRARY_PATH = os.environ.get('GDAL_LIBRARY_PATH', '/usr/lib/libgdal.so')

# NPM path ayarı için platform kontrolü
if platform.system() == 'Windows':
